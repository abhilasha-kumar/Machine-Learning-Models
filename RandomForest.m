...
for i=1:numBags
    ...
    % need to apply split-feature randomization i.e., randomly sample some
    % m = sqrt(d) features and use those for classification
    t_b = fitctree(x_tr_b, y_tr_b, 'NumVariablesToSample',m);
...
titlecaption = sprintf('Random Forest: \nOut of Bag Error as a Function of Number of Bags')
